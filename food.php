...
$pageTitle = 'Gıda Analizleri'; // Default başlık
if ($lang === 'tr') {
    $pageTitle = 'Gıda Analizleri';
} elseif ($lang === 'en') {
    $pageTitle = 'Food Analysis';
} elseif ($lang === 'mk') {
    $pageTitle = 'Анализа на храна';
}
...
<head>
    ...
    <title>Labx - <?= $current_texts['page_title'] ?? 'Gıda Analizleri' ?></title>
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><?= $current_texts['page_title'] ?? 'Gıda Analizleri' ?></h3>
                            </div>
                            <div class="panel-body">
                                <form method="GET" action="food.php" class="form-inline mb-4">
