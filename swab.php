...
$pageTitle = 'Swab Analizleri'; // Default başlık
if ($lang === 'tr') {
    $pageTitle = 'Swab Analizleri';
} elseif ($lang === 'en') {
    $pageTitle = 'Swab Analysis';
} elseif ($lang === 'mk') {
    $pageTitle = 'Анализа на брис';
}
...
<head>
    ...
    <title>Labx - <?= $current_texts['page_title'] ?? 'Swab Analizleri' ?></title>
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><?= $current_texts['page_title'] ?? 'Swab Analizleri' ?></h3>
                            </div>
                            <div class="panel-body">
                                <form method="GET" action="swab.php" class="form-inline mb-4">
