...
$pageTitle = 'Çevre Analizleri'; // Default başlık
if ($lang === 'tr') {
    $pageTitle = 'Çevre Analizleri';
} elseif ($lang === 'en') {
    $pageTitle = 'Environment Analysis';
} elseif ($lang === 'mk') {
    $pageTitle = 'Анализа на животната средина';
}
...
<head>
    ...
    <title>Labx - <?= $current_texts['page_title'] ?? 'Çevresel Analizler' ?></title>
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><?= $current_texts['page_title'] ?? 'Çevre Analizleri' ?></h3>
                            </div>
                            <div class="panel-body">
                                <form method="GET" action="environment.php" class="form-inline mb-4">
