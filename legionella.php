...
$pageTitle = 'Legionella Analizleri'; // Default başlık
if ($lang === 'tr') {
    $pageTitle = 'Legionella Analizleri';
} elseif ($lang === 'en') {
    $pageTitle = 'Legionella Analysis';
} elseif ($lang === 'mk') {
    $pageTitle = 'Анализа на легионела';
}
...
<head>
    ...
    <title>Labx - <?= $current_texts['page_title'] ?? 'Legionella Analizleri' ?></title>
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><?= $current_texts['page_title'] ?? 'Legionella Analizleri' ?></h3>
                            </div>
                            <div class="panel-body">
                                <form method="GET" action="legionella.php" class="form-inline mb-4">
