...
$pageTitle = 'Atık Su Analizleri'; // Default başlık
if ($lang === 'tr') {
    $pageTitle = 'Atık Su Analizleri';
} elseif ($lang === 'en') {
    $pageTitle = 'Wastewater Analysis';
} elseif ($lang === 'mk') {
    $pageTitle = 'Анализа на отпадни води';
}
...
<head>
    ...
    <title>Labx - <?= $current_texts['page_title'] ?? 'Atık Su Analizleri' ?></title>
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><?= $current_texts['page_title'] ?? 'Atık Su Analizleri' ?></h3>
                            </div>
                            <div class="panel-body">
                                <form method="GET" action="wastewater.php" class="form-inline mb-4">
