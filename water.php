...
$pageTitle = 'Su Analizleri'; // Default başlık
if ($lang === 'tr') {
    $pageTitle = 'Su Analizleri';
} elseif ($lang === 'en') {
    $pageTitle = 'Water Analysis';
} elseif ($lang === 'mk') {
    $pageTitle = 'Анализа на вода';
}
...
<head>
    ...
    <title>Labx - <?= $current_texts['page_title'] ?? 'Su Analizleri' ?></title>
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><?= $current_texts['page_title'] ?? 'Su Analizleri' ?></h3>
                            </div>
                            <div class="panel-body">
                                <form method="GET" action="water.php" class="form-inline mb-4">
